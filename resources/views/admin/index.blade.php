@extends('layouts.Interface', ['activePage' => 'Admin Management', 'titlePage' => __('Admin Management')])
        ...
        <div class="row">
            <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">This is Admin Mangement</p>
                </div>
                <div class="card-body">
                <div class="row">
                      ...
                      @foreach ($user as $i => $us)
                        <tr>
                          ...
                          ********
                          ...
                          <a type="button" rel="tooltip" class="btn btn-success btn-round" href="/Admin Management/edit/{{$us->id}}">
                          <i class="material-icons">edit</i>
                          </a>
                            <form action="/Admin Management/{{ $us->id}}" method="post" class="d-inline" onsubmit="return confirm('Apakah anda mau menghapus barang ini?')">
                            @method('delete')
                            @csrf
